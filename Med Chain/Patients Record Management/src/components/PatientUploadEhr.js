...
const PatientUploadEhr = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Calling addRecord with parameters:", patientDetails.walletAddress, timestamp, report.path);
      
      await ehrContract.methods
        .addRecord(
          patientDetails.walletAddress,  // patient wallet address as first parameter
          timestamp,
          report.path
        )
