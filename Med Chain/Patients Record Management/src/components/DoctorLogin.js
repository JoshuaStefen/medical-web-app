...
const DoctorLogin = () => {
  ...
  return (
    <div>
      <NavBar />
      <div className="bg-gray-900 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-white">
        <div className="w-full max-w-4xl bg-gray-900 p-20 rounded-lg shadow-lg">
          ...
          <button
            ...
            className="px-6 py-3 text-white font-bold text-lg rounded-lg cursor-pointer bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-indigo-600 hover:to-purple-600 transition-all duration-50 transform hover:scale-105"
          >
            Login
          </button>
          <button
