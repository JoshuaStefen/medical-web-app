      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="space-x-4 text-center mt-6">
          <button
            ...
            className="py-3 px-4 text-white rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-indigo-600 hover:to-purple-600 transition-all duration-50 transform hover:scale-105"
          >
            Register
          </button>
          <button
            onClick={cancelOperation}
            className="py-3 px-4 text-white rounded-md font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-indigo-600 hover:to-purple-600 transition-all duration-50 transform hover:scale-105"
            >
            Close
          </button>
        </div>
