    ...
    <div>
      ...
      <div className="bg-gray-900 text-white font-sans min-h-screen flex items-center justify-center">
        ...
        >
          ...
          {/* Content */}
          <div className="flex flex-col text-custom-blue space-y-8 w-2/5 p-8 bg-blue-950 shadow-lg ml-4 rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
