      ...
      <div className="bg-gray-900 p-4 sm:p-10 font-mono text-white h-screen flex flex-col justify-center items-center">
        ...
        <div className="space-y-4 space-x-4">
          <button
            ...
            className="px-6 py-3 text-white rounded-lg focus:outline-none bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-indigo-600 hover:to-purple-600 transition-all duration-50 transform hover:scale-105"
          >
            View Profile
          </button>
          <button
