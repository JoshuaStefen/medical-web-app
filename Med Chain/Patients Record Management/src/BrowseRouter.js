...
import AvailableDiagnostics from "./components/AvailableDiagnostics";
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/AboutPage" element={<AboutUs></AboutUs>}></Route>
        ...
        <Route
          path="/patient/:hhNumber/availabledoctors"
          element={<AvailableDoctors />}
          />
         <Route
           path="/patient/:hhNumber/availablediagnostics"
           element={<AvailableDiagnostics />}
          />
